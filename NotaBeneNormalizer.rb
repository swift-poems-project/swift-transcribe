...
#     poem = poem.gsub(/#{Regexp.escape("186B1451   5  ||Of «MDUL»arma virumque,")}/, "186B1451   5  ||Of «MDUL»arma virumque,«MDNM»")
     ...
     poem = poem.gsub(/#{Regexp.escape("Y29-03P1   16  |But mine is on sweet «MDUL»Molly Mog.")}/, "Y29-03P1   16  |But mine is on sweet «MDUL»Molly Mog«MDNM».")
     poem = poem.gsub(/#{Regexp.escape("Y29-03P1   17  _Will-a-wisp«MDNM» leads the Trav'ler a gadding")}/, "Y29-03P1   17  _Will-a-wisp leads the Trav'ler a gadding")
